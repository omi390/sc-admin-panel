...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Web\Admin', 'middleware' => ['admin']], function () {
    ...
    Route::group(['prefix' => 'service', 'as' => 'service.'], function () {
        ...
        Route::any('ajax-delete-db-variant/{variant_key}/{service_id}', 'ServiceController@ajaxDeleteDbVariant')->name('ajax-delete-db-variant')->withoutMiddleware('csrf');
                Route::any('ajax-get-providers', 'ServiceController@getProvidersByZoneAndSubcategory')->name('ajax-get-providers')->withoutMiddleware('csrf');
        Route::any('ajax-update-provider-variant', 'ServiceController@ajaxUpdateProviderVariant')->name('ajax-update-provider-variant')->withoutMiddleware('csrf');
