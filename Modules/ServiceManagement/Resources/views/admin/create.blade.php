                        ...
                        <div class="card-body p-30">
                            <div>
                                ...
                                <form action="{{route('admin.service.store')}}" method="post"           enctype="multipart/form-data"
                                    ...
                                    <section>
                                        @include('servicemanagement::admin.partials._procedures', ['procedures' => collect()])
                                    </section>

                                    <h3>{{ translate('service_note') }}</h3>
                                    <section>
                                        @include('servicemanagement::admin.partials._notes', ['notes' => collect()])
                                    </section>

                                    <h3>{{ translate('pros_and_cons') }}</h3>
                                    <section>
                                        @include('servicemanagement::admin.partials._pros-and-cons', ['prosAndCons' => collect()])
                                    </section>

                                    <h3>{{ translate('faq') }}</h3>
                                    <section>
                                        @include('servicemanagement::admin.partials._faqs-inline', ['faqs' => collect()])
                                    </section>

                                    <h3>{{ translate('policy') }}</h3>
                                    <section>
                                        @include('servicemanagement::admin.partials._policies', ['policies' => collect()])
                                    </section>

                                    <h3>{{ translate('code') }}</h3>
                                    <section>
                                        @include('servicemanagement::admin.partials._code', ['service' => null])
                                    </section>
