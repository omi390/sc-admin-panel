...
Route::group(['prefix' => 'customer', 'as' => 'customer.', 'namespace' => 'Api\V1\Customer'], function () {
    ...
    Route::group(['prefix' => 'advertisements', 'as' => 'advertisements.'], function () {
        ...
        Route::get('reviews-list', 'AdvertisementsController@ReviewList')->name('reviews-list');
        Route::get('customer-reviews-list', 'AdvertisementsController@CustomerReviewList')->name('customer-reviews-list');
