...
Route::group(['prefix' => 'user', 'namespace' => 'Api\V1'], function () {
    //verification
            ...
            Route::get('/tendors', [UserController::class, 'tendors']);
            Route::post('/create-payment-session', [UserController::class, 'createPaymentSession']);
            Route::post('/check-payment-session', [UserController::class, 'checkCashfreeStatus']);
...
Route::group(['prefix' => 'provider', 'namespace' => 'Api\V1'], function () {
    ...
    Route::group(['prefix' => 'verification'], function () {
        Route::post('send-otp', [OTPVerificationController::class, 'sendProviderOTP']);
        Route::post('verify-otp', [OTPVerificationController::class, 'providerVerifyOTP']);
