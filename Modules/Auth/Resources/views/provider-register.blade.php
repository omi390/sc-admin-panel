                    ...
                    <form action="{{route('provider.auth.sign-up-submit')}}" method="POST" enctype="multipart/form-data" id="register-vertical-steps">
                                    ...
                                    <div class="mb-30">
                                        <div class="form-error-wrap">
                                            <select name="identity_type" id="identity_type"
                                                ...
                                                <option
                                                    value="nid" {{old('identity_type')=='nid'?'selected':''}}>Adhar Card</option>
                                                <option
                        ...
                        <section>
                            <div class="">
                                    ...
                                    <div class="d-flex flex-column gap-3">
                                        ...
                                        @if($subscription && count($formattedPackages) > 0)
                                            <label class="business-plan-option border rounded p-3 d-flex justify-content-between gap-2">
                                                ...
                                                <input value="subscription_base" checked="checked" type="radio" name="choose_business_plan" class="position-static w-26">
                                            </label>
                                        @endif
                                    </div>
                                </div>
                                ...
                                @if($subscription)
                                    <div class="priceBoxSwiper-wrap d-block" style="display:block">
                                                        ...
                                                        <div class="swiper-slide h-auto">
                                                            <div class="price-box {{ $index == 1 ? 'active' : '' }} d-flex flex-column rounded-3 border h-100 package-option" data-id="{{ $package->id }}">
                                                                ...
                                                                <div class="p-3 flex-grow-1 d-flex flex-column">
                                                                    <ul class="d-flex flex-column align-items-center gap-2 p-0 fs-12 mb-30" style="list-style:none">
                                                                        ...
                                                                        <!--@endforeach-->
                                                                         ...
                                                                         <li>Unlimited Bookings</li>
                                                                                 <li>15+ Service Catgories</li>
                                                                                     <li>Access B2C and B2B Customers</li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
