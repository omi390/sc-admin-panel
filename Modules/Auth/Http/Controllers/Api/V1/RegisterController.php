...
class RegisterController extends Controller
{
    ...
    public function providerRegisterOTP(Request $request): JsonResponse
    {
        ...
        $provider->company_phone =$request->mobile;
        ...
        $owner = $this->owner;
        $owner->first_name = 'Provider Name';
        $owner->last_name = $request->account_last_name;
        $owner->email = null;
        $owner->phone = $request->mobile;
