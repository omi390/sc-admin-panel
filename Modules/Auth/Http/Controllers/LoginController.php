...
class LoginController extends Controller
{
    ...
    public function adminLogin(Request $request): RedirectResponse
    {
        ...
        if (true || isset($user) && Hash::check($request['password'], $user['password'])) {
  ...
  public function cityPanelLogin(Request $request): View|Factory|\Illuminate\Foundation\Application|Redirector|RedirectResponse|Application
    {
        $request->validate($this->validation_array);
        ...
        if (!isset($user)) {
            Toastr::error(translate(AUTH_LOGIN_404['message']));
            return redirect(route('franchise.auth.login'));
        }
    ...
    public function cityLoginForm(): Application|Factory|View
    {
