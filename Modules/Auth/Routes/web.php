...
// city panel 
Route::group(['prefix' => 'franchise', 'as' => 'franchise.', 'namespace' => null], function () {
    Route::group(['prefix' => 'auth', 'as' => 'auth.'], function () {
    

        Route::get('login', 'LoginController@cityLoginForm')->name('login');
        Route::post('login', 'LoginController@cityPanelLogin');
    //     Route::get('logout', 'LoginController@logout')->name('logout');
