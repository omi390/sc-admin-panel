...
Route::group(['prefix' => 'provider', 'as' => 'provider', 'namespace' => 'Api\V1'], function () {
    ...
    Route::group(['prefix' => 'auth', 'as' => 'auth.'], function () {
        ...
        Route::post('provider-otp-register', 'RegisterController@providerRegisterOTP')->name('provider.otp.login');


    });
    Route::post('check-provider-status', 'RegisterController@providerStatus')->name('provider.check-status');
