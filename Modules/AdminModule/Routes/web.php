...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Web\Admin', 'middleware' => ['admin']], function () {
    ...
    Route::get('dashboard', 'AdminController@dashboard')->name('dashboard');
        Route::get('tendors','AdminController@tendors')->name('tendors');
        Route::get('tendors/edit/{id}','AdminController@tendorEdit')->name('tendors.edit');
        Route::delete('tendors/destroy/{id}','AdminController@tendorDestroy')->name('tendors.destroy');
        Route::put('tendors/update/{id}','AdminController@tendorUpdate')->name('tendors.update');
        Route::get('tendors/create','AdminController@tendorCreate')->name('tendors.create');
        Route::post('tendors/store','AdminController@tendorStore')->name('tendors.store');
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Web\Admin'], function () {
        Route::get('tabs', [TransactionReportController::class, 'tabs'])->name('tabs');
        Route::get('tabs/delete/{id}', [TransactionReportController::class, 'tabsDelete'])->name('tabsDelete');
        Route::post('tabs/save', [TransactionReportController::class, 'tabSave'])->name('tabSave');
