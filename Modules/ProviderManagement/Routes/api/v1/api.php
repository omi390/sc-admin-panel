...
Route::group(['prefix' => 'provider', 'as' => 'provider.', 'namespace' => 'Api\V1\Provider', 'middleware' => ['auth:api']], function () {
    ...
    Route::get('tendors', 'ProviderController@tendors');
    Route::post('tendor/save', 'ProviderController@saveTendor');
    ...
    Route::group(['prefix' => 'account', 'as' => 'account.',], function () {
        ...
        Route::get('status', 'AccountController@providerStatus');
        ...
        Route::post('complete-provider-form', 'AccountController@completeProviderForm')->name('provider.complete-provider-form');
