                                    ...
                                    @can('provider_update')
                                        <a href="{{route('admin.provider.collect_cash.list', [$provider->id])}}"
                                          ...
                                          <!-- Trigger Button -->
                                            ...
                                            <!-- Modal -->
                                               <form method="POST" action="{{route('admin.provider.collect_cash.charge')}}">
                                                  @csrf
                                                  <input type="hidden" name="user_id" value="{{$provider->user_id}}"/>
                                                  <div class="mt-4 form-row row align-items-center">
                                                    <div class="col">
                                                      <input type="number" min="1" class="form-control" name="amount" placeholder="Enter Amount To Charge" required>
                                                    </div>
                                                    <div class="col-auto">
